.. title:: SEO Panel Plugin Installation & Upgrade Guide

.. meta::
   :description: How to install, activate and upgrade SEO Panel plugins — covers FTP and SSH upload methods, Plugin Manager activation, compatibility checks and troubleshooting.
